...
import com.reis.hiddemcam.lib.CaptureTimeFrequency.OneShot
import com.reis.hiddemcam.lib.CaptureTimeFrequency.Recurring
import java.io.File
...
class HiddenCam @JvmOverloads constructor(
    ...
    private fun capture() {
        imageCapture.takePicture(
            createFile(baseFileDirectory), MainThreadExecutor,
